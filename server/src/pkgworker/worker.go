...
func NewPackageWorker(searcher pkgsearcher.Searcher, scraper pkgscraper.Scraper, storer pkgstorage.Storer, searchInt time.Duration, scrapeInt time.Duration) *PackageWorker {
